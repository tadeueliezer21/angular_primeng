...
export class LancamentosPesquisaComponent {
  ...
  lancamentos = [
    ...
    {
      tipo: 'RECEITA', descricao: 'Venda de software', dataVencimento: new Date(2017, 6, 28),
      dataPagamento: new Date (2017, 9, 6), valor: 80000, pessoa: 'Atacado Brasil'
    },
    {
    ...
    {
      tipo: 'RECEITA', descricao: 'Venda de carro', dataVencimento: new Date(2017, 8, 19),
      dataPagamento: null, valor: 55000, pessoa: 'Sebastião Souza'
    },
    {
      tipo: 'DESPESA', descricao: 'Aluguel', dataVencimento: new Date(2017, 7, 17),
